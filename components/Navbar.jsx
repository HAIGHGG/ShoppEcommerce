...
const Navbar = () => {
	...
	return (
		<div className='flex flex-row justify-between mb-5 xl:mb-10'>
			...
			<button type='button' className='relative flex items-center justify-center rounded-2xl text-indigo-700 bg-white p-2 xl:w-10 xl:h-10 xl:rounded-3xl' onClick={() => setShowCart(true)}>
				<AiOutlineShopping />
